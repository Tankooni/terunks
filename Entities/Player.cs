...
namespace NHTI.Entities
{
	...
	public class Player : Entity
	{
		...
		public static Dictionary<string, AnimationData> BodyAnimDict = new Dictionary<string, AnimationData>()
		{
			...
			{ "DuckStand", new AnimationData (6, FP.MakeFrames(21,24,1).Reverse().ToArray(), false, new int[]{260,240,200,150})},
			{ "DuckShuffle", new AnimationData (8, FP.MakeFrames(26,35,1), true, new int[]{260,260,260,260,260,260,260,260,260,260})},
			{ "Jump", new AnimationData (6, FP.MakeFrames(36,41,1), false, new int[]{150,150,75,75,65,65})},
			{ "JumpIdle", new AnimationData (4, FP.Frames(40,41), true, new int[]{65,65})},
			{ "Fall", new AnimationData (6, FP.MakeFrames(42,47,1), false, new int[]{65,65,115,115,150,150})},
			{ "FallIdle", new AnimationData (4, FP.Frames(46,47), true, new int[]{150,150})},
			{ "Dash", new AnimationData (10, FP.Frames(48,49), true, null)},
			{ "Stagger1", new AnimationData (8, FP.MakeFrames(50,54,1), false, null)},
			{ "Stagger2", new AnimationData (8, FP.MakeFrames(55,59,1), false, null)},
			{ "Death", new AnimationData (4, FP.MakeFrames(60,91,1), false, null)},
			{ "Dance", new AnimationData (6, FP.MakeFrames(92, 106,1), false, null)}
		};
		...
		public static Dictionary<string, AnimationData> FaceAnimDict = new Dictionary<string, AnimationData>()
		{
			...
			{ "FallIdle", new AnimationData (4, FP.MakeFrames(32, 33, 1), true, null)},
			{ "ChargeAttack", new AnimationData (3, FP.MakeFrames(34, 41, 1), false, null)},
			{ "ChargeAttackLoop", new AnimationData (1, FP.MakeFrames(42,45, 1), true, null)},
			{ "Release", new AnimationData (6, FP.MakeFrames(46, 57, 1), false, null)}
		};
